...
function tree($dir_antes,$dir_corrente,$indice){
    ...
    $is_proibido=true;
    if (
        $dir_corrente == "/apps/asterisk/etc" || 
        $dir_corrente == "/apps/asterisk/etc/asterisk" || 
